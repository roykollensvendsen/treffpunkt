...
Instead of tapping each shot onto the on-screen target, you can **photograph your
paper target** and mark the hits on the photo. The app scores them just the same.

## Steps

1. While shooting a series, tap **Skann skive** (the scanner icon) in the top
   bar.
